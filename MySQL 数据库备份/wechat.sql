...
CREATE TABLE `comment` (
  ...
  `num_like` bit(1) DEFAULT b'0',
  `content` text,
  PRIMARY KEY (`comment_id`),
  KEY `user_fk2` (`commentator`),
  KEY `circle_fk` (`circle_id`),
...
--
-- Dumping data for table `friend_circle`
--

LOCK TABLES `friend_circle` WRITE;
/*!40000 ALTER TABLE `friend_circle` DISABLE KEYS */;
/*!40000 ALTER TABLE `friend_circle` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-06-09 19:03:27
