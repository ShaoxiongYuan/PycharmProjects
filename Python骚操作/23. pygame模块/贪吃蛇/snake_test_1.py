...
pygame.init()
speed = [50, 70, 90, 110,
         130]  # list of possible speeds, each element is the number of milliseconds the program waits before a move
...
moves = [0, 0, 0,
         0]  # tells wich key is pressed (up,down,left,right), i use this list so as to when the user presses a key the snake keeps moving while the key is pressed
...
tail = [pygame.image.load("image\snake_p_tail_d_30.png").convert(),
        pygame.image.load("image\snake_p_tail_l_30.png").convert(),
        pygame.image.load("image\snake_p_tail_r_30.png").convert(),
        pygame.image.load("image\snake_p_tail_u_30.png").convert()]
# list of normal snake head images in different directions
head_m = [pygame.image.load("image\snake_p_m_d_30.png").convert(),
          pygame.image.load("image\snake_p_m_l_30.png").convert(),
          pygame.image.load("image\snake_p_m_r_30.png").convert(),
          pygame.image.load("image\snake_p_m_u_30.png").convert()]
# list of eating snake head images in different directions
head_eat = [pygame.image.load("image\snake_p_eat_d_30.png").convert(),
            pygame.image.load("image\snake_p_eat_l_30.png").convert(),
            pygame.image.load("image\snake_p_eat_r_30.png").convert(),
            pygame.image.load("image\snake_p_eat_u_30.png").convert()]
# list of snake parts with no corners 
snake_parts = [pygame.image.load("image\snake_p_1_30.png").convert(),
               pygame.image.load("image\snake_p_2_30.png").convert(),
               pygame.image.load("image\snake_p_3_30.png").convert(),
               pygame.image.load("image\snake_p_4_30.png").convert(),
               pygame.image.load("image\snake_p_5_30.png").convert()]
# list of corner snake parts 
snake_moves = [pygame.image.load("image\snake_p_d_30.png").convert(),
               pygame.image.load("image\snake_p_l_30.png").convert(),
               pygame.image.load("image\snake_p_r_30.png").convert(),
               pygame.image.load("image\snake_p_u_30.png").convert()]
...
def show_snake():  # draw snake on the screen
    ...
    for position, move in zip(snake[1:len(snake) - 1],
                              direction[1:len(direction) - 1]):  # draw the middle parts of the snake
    ...
    pygame.draw.rect(fenetre, (255, 255, 255),
                     [600, 600, 10, 50])  # draw a white rectangle in the bottom right of the screen
